...
const UserDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100" dir={direction}>
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-500 to-indigo-500 shadow-lg">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <h1 className="text-4xl font-bold text-white">
                {t('messages.welcome')}, <span className="text-blue-100">{user?.username}</span>
              </h1>
              <p className="text-blue-100 mt-2 text-lg">{t('user.dashboard')}</p>
            </div>
      ...
      <div className="max-w-6xl mx-auto p-4 sm:p-6">
        ...
        <div className="mb-8">
          <Link
            to="/report"
            className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-lg hover:shadow-xl transition duration-300 transform hover:scale-105 active:scale-95 font-semibold shadow-lg"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-xl transition duration-300 border-t-4 border-orange-500">
          <div className="flex items-center">
